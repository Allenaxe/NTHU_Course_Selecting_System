...
# time_interval_list = ['1', '2', '3', '4', 'n', '5', '6', '7', '8', '9', 'a','b','c']
# ###一上課表
# oneup_data = df_schedule
...
#         oneup_data[row][col] = str(result_df.iloc[num]['中文課名'])+str('\n')+str(result_df.iloc[num]['上課時間'])
#         print(oneup_data[row][col])
